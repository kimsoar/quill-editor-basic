    ...
    methods: {
        ...
        uploadFileInDto() {
            ...
            elem.onchange = function() {
                ...
                axios.post('http://localhost:8080/file/uploadfile', formData, { headers: { 'Content-Type': 'multipart/form-data' } }).then(context.responseCallback).catch(context.errorCallback);
            }
        },
        uploadFileListInDto() {
            var context = this;
            ...
            elem.onchange = function() {
                ...
                axios.post('http://localhost:8080/file/uploadmultiplefiles', formData, { headers: { 'Content-Type': 'multipart/form-data' } }).then(context.responseCallback).catch(context.errorCallback);
            }
        },
        uploadFileMapInDto() {
            var context = this;

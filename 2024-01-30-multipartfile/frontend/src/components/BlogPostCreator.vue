  ...
  <div class="blog-post-creator rteditor">
    <div class="post-inputs">
      <div class="title-input">
        <ErrorText v-if="!title && formEntered"
          >Title must be more than 10 characters.</ErrorText
        >
        <Input v-model="title" placeholder="Enter a post title" />
      </div>
      <div class="cat-input">
        <ErrorText v-if="!category && formEntered"
          >Post must have a category</ErrorText
        >
        <Select
      ...
      <div class="image-input">
        <ErrorText v-if="!image_url && formEntered"
          >Post must have an image</ErrorText
        >
